...
@Component({
	selector: 'ms-step-recommend-grasp',
	templateUrl: './step-recommend-grasp.component.html',
	styleUrls: ['./step-recommend-grasp.component.scss']
})
export class StepRecommendGraspComponent {
	...
	constructor(
		...
		this.algorithms = getSpecificAlgorithmOptions([
			PruningAlgorithmsEnum.IPG,
			PruningAlgorithmsEnum.IPR,
			PruningAlgorithmsEnum.IPM
		]);
	}
