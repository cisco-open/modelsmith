...
import { CSSUnit } from './models/types/css-unit.type';
 ...
 */
export function getDialogSizeStyles(width?: CSSSize, height?: CSSSize): { [klass: string]: any } {
 ...
 */
function applySizeStyle(styles: { [klass: string]: any }, value: CSSSize, dimension: 'width' | 'height'): void {
