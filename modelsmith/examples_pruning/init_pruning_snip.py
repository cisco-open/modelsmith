...
def main():
    ...
    logger.log('# Pruning at initialization with Snip #')
    ...
    # Prune
    snip_pruning(net, args.pruning_ratio, trainloader, num_class=10, logger=logger)
