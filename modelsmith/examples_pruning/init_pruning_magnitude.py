...
from utils.pruner import pruning_model_random, check_sparsity, pruning_model

def main():
    # In[3]:

    # Argument parser
    parser = argparse.ArgumentParser(description='Pruning at initialization with magnitude pruning')
    ...
    print('# Pruning at initialization with magnitude pruning #', flush=True)
