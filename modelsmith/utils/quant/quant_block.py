...
from models.resnet_quant import BasicBlock, Bottleneck
...
class QuantBasicBlock(BaseQuantBlock):
    ...
    def __init__(self, basic_block: BasicBlock, weight_quant_params: dict = {}, act_quant_params: dict = {}):
        ...
        self.conv1.activation_function = nn.ReLU(inplace=True)
...
#         self.conv2.activation_function = nn.ReLU(inplace=True)
