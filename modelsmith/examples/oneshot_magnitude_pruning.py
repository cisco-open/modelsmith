...
print('# Post-training pruning: iterative magnitude pruning (IMP) #')
...
print('# Start Standard Training Iterative Pruning #', flush=True)

for state in range(pruning_times):

    print('******************************************', flush=True)
    print('pruning state', state, flush=True)
    print('******************************************', flush=True)
