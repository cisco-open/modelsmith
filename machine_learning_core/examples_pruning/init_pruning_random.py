...
def main():
    ...
    parser = argparse.ArgumentParser(description='Pruning at initialization with random pruning')
    ...
    logger.log('# Pruning at initialization with random pruning #')
    ...
    # Prune
    pruning_model_random(net, args.pruning_ratio)
